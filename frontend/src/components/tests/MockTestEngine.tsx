...
export default function MockTestEngine({ test, userId }: MockTestEngineProps) {
  ...
  return (
    <div className="bg-slate-100 min-h-screen flex flex-col font-sans select-none">
      ...
      <header className="bg-slate-900 text-white px-3 sm:px-4 py-2.5 sm:py-3 border-b border-slate-800 sticky top-0 z-30 shadow-md">
        <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-between gap-2 sm:gap-4">
          ...
          <div className="flex items-center gap-2 sm:gap-4 shrink-0 ml-auto">
            {/* Bilingual Toggle */}
            <div className="flex items-center bg-slate-800 rounded-lg p-0.5 border border-slate-700 text-[11px] sm:text-xs">
              <button
            ...
            {/* Countdown Timer */}
            <div
              className={`flex items-center gap-1.5 sm:gap-2 px-2.5 sm:px-3.5 py-1 sm:py-1.5 rounded-xl font-mono text-xs sm:text-base font-bold border shadow-inner ${
                timeLeft < 300
            ...
            <button
              ...
              className="bg-emerald-600 hover:bg-emerald-700 text-white text-xs sm:text-sm font-bold px-3 sm:px-4 py-1 sm:py-1.5 rounded-xl shadow transition-all"
            >
              Submit
            </button>
          </div>
